...
public class EventManager implements EventBus
{
    ...
    public EventManager() {
        this.SUBSCRIPTION_CACHE = new ConcurrentHashMap<Object, List<Listener>>();
    ...
    public void subscribeAll(final Object... objects) {
        Arrays.stream(objects).forEach(this::subscribe);
    }
    
    public void subscribeAll(final Iterable<Object> objects) {
    ...
    public void unsubscribeAll(final Object... objects) {
        Arrays.stream(objects).forEach(this::unsubscribe);
    }
    
    public void unsubscribeAll(final Iterable<Object> objects) {
